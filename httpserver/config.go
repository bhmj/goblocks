...
type Config struct {
	...
	TLSCA            string        `yaml:"tls_ca" description:"Optional CA certificate"`
	TLSUseClientCert bool          `yaml:"tls_use_client_cert" description:"Require and verify client certificate"`
	TLSClientCA      string        `yaml:"tls_client_ca" description:"Certificate Authority file for checking the authenticity of client"` //nolint:lll
